...
<head>
  ...
  <link rel="stylesheet" tyep="text/css" href="css/carousel.css">
<title>HOME</title>
</head>
<body>
  <header class="header">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li role="presentation" class="active" style="font-family: Bayon ;font-size: 18px;">
              <a href="login.php"><i class="fa fa-home"></i> SERVICE PORTAL</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.navbar-collapse container-fluid -->
  </nav>
  </header>
<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="120000">
        

        <div class="item">
<iframe width="100%" height="100%" frameborder="0" src="css/brand/cyber.gif" allowfullscreen="" webkitallowfullscreen="" mozallowfullscreen="" oallowfullscreen="" msallowfullscreen=""></iframe>
